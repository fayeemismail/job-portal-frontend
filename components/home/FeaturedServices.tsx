      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-12">
          ...
          <Link href="/services" className="w-fit">
            <button
              type="button"
              className="px-6 py-4 bg-[#EE5E36] hover:bg-[#0B2545] text-white font-bold text-sm tracking-wider rounded-xl transition-all duration-300 flex items-center justify-center gap-2 group cursor-pointer shadow-md shadow-[#EE5E36]/15 hover:shadow-lg"
            >
