      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-12">
          ...
          <Link href="/services" className="w-fit block">
            <button
              type="button"
              className="btn-animate btn-animate-primary px-6 py-4 font-bold text-sm tracking-wider rounded-xl flex items-center justify-center gap-2 cursor-pointer shadow-md shadow-[#EE5E36]/15 hover:shadow-lg"
            >
